        ...
        <div class="col-md-12">
            <div class="list-group" style="width: 100%;box-shadow: 0 0 9px 4px rgba(255,255,255,0.50),0 1px 10px 0 rgba(9,9,9,9.12),0 2px 4px -1px rgba(9,9,9,9.3);">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <form action="laporan/cetak_disposisi.php" method="post" target="_blank">
                            ...
                            <div class="col-md-6">
                                <a href="laporan/cetak_disposisi.php" target="_blank" class="btn btn-sm btn-success btn-lg btn-block"><i class="fa fa-print"></i> Cetak Semua</a>
                            </div>
                            <div class="col-md-6">
