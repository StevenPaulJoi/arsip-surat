                    ...
                    while ($baris = mysqli_fetch_array($q_disposisi))
                    {
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; font-family: 'Arial', sans-serif">
                                <a href="?page=detail_disposisi&no_disposisi=<?php echo $baris['no_disposisi'];?>"><?php echo $baris['no_disposisi'];?></a>
                            </td>
                            <td style="text-align: center; font-family: 'Arial', sans-serif">
                            ...
                            <td style="text-align: center; font-family: 'Arial', sans-serif">
                                ...
                                if($baris['status_disposisi'] == "Belum dibaca"){
                                    ?>
                                    <a href="?page=detail_disposisi&no_disposisi=<?php echo $baris['no_disposisi'];?>" style="text-decoration: none"><button class="btn btn-primary btn-block btn-sm" style="cursor: pointer"><?php echo$baris['status_disposisi'];?> <i class="fa fa-share-square"></i></button></a>
                                <?php
                                }elseif($baris['status_disposisi'] == "Sudah dibaca"){
                                    ?>
                                    <button class="btn btn-success btn-block btn-sm disabled" style="cursor: default"><?php echo$baris['status_disposisi'];?> <i class="fa fa-check-circle"></i></button>
                                <?php
                                }
                                ?>
                            </td>
                            <td align="center" style="font-family: 'Arial', sans-serif">
                                <a class="btn btn-danger btn-sm" onclick="return confirm('yakin ingin menghapus')" href="disposisi/hapus_disposisi.php?no_disposisi=<?php echo $baris['no_disposisi'];?>"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
