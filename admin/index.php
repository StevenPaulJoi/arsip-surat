...
$qprofile=mysqli_query($conn,"select * from tb_petugas where id_petugas = '$_SESSION[Admin]'");
...
<br><div class="wrapper" style="border-top: solid #283593 22px;margin-top: -20px">
    <h2><b>SISTEM INFORMASI <small>Absen Pegawai</small></b></h2>
    <hr>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="?page=nomor_surat">Input Nomor Surat</a></li>
                            <li><a href="?page=jenis_surat">Input Jenis Surat</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="?page=galeri_surat_masuk">Galeri Surat Masuk</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="?page=logeditsurat">Log Edit Surat</a></li>
                            <li><a href="?page=loghapussurat">Log Hapus Surat</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="?page=backup_database">Backup Database</a></li>
                            <li><a href="?page=kelola_petugas">Pengaturan Petugas</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="container-fluid" style="margin-left: -29px">
        ...
        switch ($page){
            ...
            case 'nomor_surat' : include "input_surat/nomor_surat.php"; break;
            case 'jenis_surat' : include "input_surat/jenis_surat.php"; break;
            ...
            case 'detail_surat_masuk' : include "surat_masuk/detail_suratmasuk.php"; break;
            ...
            case 'detail_surat_keluar' : include "surat_keluar/detail_suratkeluar.php"; break;
            ...
            case 'logeditsurat' : include "laporan/logeditsurat.php"; break;
            case 'loghapussurat' : include "laporan/loghapussurat.php"; break;
            case 'laporansurat' : include "laporan/laporan_surat.php"; break;

            case 'kelola_petugas' : include "pengaturan/kelola_petugas.php"; break;
            case 'edit_petugas' : include "pengaturan/edit_petugas.php"; break;
            case 'backup_database' : include "pengaturan/backup_database.php"; break;
