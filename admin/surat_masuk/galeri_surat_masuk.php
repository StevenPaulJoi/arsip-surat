                        ...
                        while($gambar=mysqli_fetch_array($s_gsm)){
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail text-white bg-default mb-3" style="width: 100%">
                                    <div class="card-body">
                                        <a href="?page=detail_surat_masuk&no_agenda_masuk=<?php echo $gambar['no_agenda_masuk']?>" style="text-decoration: none"><h6 style="margin-left: 44px;color: black;">No Agenda : <font><?php echo $gambar['no_agenda_masuk']?></font></h6></a>
